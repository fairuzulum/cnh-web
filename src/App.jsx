...
import { Droplets, Award, Shield, CheckCircle, Phone, Mail, MapPin, Star, Menu, X } from 'lucide-react'
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 w-full overflow-x-hidden">
          ...
          >
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600 text-sm sm:text-base">pH 9+ Alkaline</span>
              </div>
              <div className="flex items-center space-x-2">
                <Shield className="h-5 w-5 text-blue-500" />
                <span className="text-gray-600 text-sm sm:text-base">Tersertifikasi</span>
              </div>
              <div className="flex items-center space-x-2">
                <Award className="h-5 w-5 text-yellow-500" />
                <span className="text-gray-600 text-sm sm:text-base">Premium Quality</span>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 w-full max-w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-4 text-gray-800">pH 9+ Alkaline</h4>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-4 text-gray-800">Kualitas Terjamin</h4>
              <p className="text-gray-600 text-sm sm:text-base">
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-4 text-gray-800">Premium Quality</h4>
              <p className="text-gray-600 text-sm sm:text-base">
      ...
      {/* Products Section */}
      <section id="products" className="py-16 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="container mx-auto px-4 sm:px-6 w-full max-w-full">
          <motion.div 
            className="text-center mb-12"
            initial={{ y: 30, opacity: 0 }}
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h5 className="font-semibold text-gray-800 text-sm sm:text-base">Menyeimbangkan pH Tubuh</h5>
                    <p className="text-gray-600 text-sm sm:text-base">Membantu menetralkan asam berlebih dalam tubuh</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <h5 className="font-semibold text-gray-800 text-sm sm:text-base">Hidrasi Optimal</h5>
                    <p className="text-gray-600 text-sm sm:text-base">Molekul air yang lebih kecil untuk penyerapan lebih baik</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <h5 className="font-semibold text-gray-800 text-sm sm:text-base">Antioksidan Alami</h5>
                    <p className="text-gray-600 text-sm sm:text-base">Membantu melawan radikal bebas dalam tubuh</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <h5 className="font-semibold text-gray-800 text-sm sm:text-base">Meningkatkan Energi</h5>
                    <p className="text-gray-600 text-sm sm:text-base">Membantu meningkatkan metabolisme dan energi tubuh</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 w-full max-w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <img src={iso9001} alt="ISO 9001" className="w-20 h-20 mx-auto mb-4 object-contain" />
              <h4 className="text-lg sm:text-xl font-bold mb-4 text-gray-800">ISO 9001:2015</h4>
              <p className="text-gray-600 text-sm sm:text-base">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <img src={bpomLogo} alt="BPOM" className="w-20 h-20 mx-auto mb-4 object-contain" />
              <h4 className="text-lg sm:text-xl font-bold mb-4 text-gray-800">BPOM RI</h4>
              <p className="text-gray-600 text-sm sm:text-base">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <img src={halalLogo} alt="Halal" className="w-20 h-20 mx-auto mb-4 object-contain" />
              <h4 className="text-lg sm:text-xl font-bold mb-4 text-gray-800">Halal MUI</h4>
              <p className="text-gray-600 text-sm sm:text-base">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-xl sm:text-2xl font-bold mb-4">Komitmen Kualitas Kami</h4>
      ...
      <section id="test-results" className="py-16 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="container mx-auto px-4 sm:px-6 w-full max-w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Telepon</h4>
                    <p className="text-gray-600 text-sm sm:text-base">+62 813 1838 1219</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Email</h4>
                    <p className="text-gray-600 text-sm sm:text-base">info@cnh-water.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Alamat</h4>
                    <p className="text-gray-600 text-sm sm:text-base">
            ...
            >
              <div className="bg-white rounded-3xl p-6 shadow-xl">
                <h4 className="text-xl sm:text-2xl font-bold mb-6 text-gray-800">Kirim Pesan</h4>
                <div className="space-y-6">
                  <div>
                  ...
                  <Button className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white py-2 rounded-lg text-base sm:text-lg font-semibold shadow-lg transition-all duration-300">
                    Kirim Pesan
                  </Button>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <div className="w-8 h-8 bg-cyan-600 rounded-full flex items-center justify-center transition-colors cursor-pointer">
                  <Star className="h-4 w-4" />
                </div>
                <div className="w-8 h-8 bg-green-600 rounded-full flex items-center justify-center transition-colors cursor-pointer">
                  <Star className="h-4 w-4" />
                </div>
              </div>
            </div>
            ...
            <div>
              <h4 className="text-base sm:text-lg font-bold mb-6">Produk</h4>
            ...
            <div>
              <h4 className="text-base sm:text-lg font-bold mb-6">Perusahaan</h4>
              <ul className="space-y-3 text-gray-400 text-sm sm:text-base">
